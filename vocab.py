...
class Vocab(object):
    ...
    @classmethod
    def build(cls, src_sents, tgt_sents) -> 'Vocab':
        """ Build Vocabulary.
    ...
    def load(cls, file_path):
        ...
        return cls(VocabEntry(src_word2id), VocabEntry(tgt_word2id))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("Training vocabulary")
    ...
    src_sents = get_vocab_list(args.train_src, source='src', vocab_size=21000)
    tgt_sents = get_vocab_list(args.train_tgt, source='tgt', vocab_size=8000)
